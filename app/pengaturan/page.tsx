...
export default function PengaturanPage() {
  ...
  return (
    <AdminShell
      title="Pengaturan RT"
      description="Atur identitas wilayah untuk laporan dan data sensus warga."
    >
      {isLoading ? (
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
          <form onSubmit={handleSubmit} className="rounded-xl bg-white p-6 shadow">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Data ini akan digunakan untuk header laporan, print, dan identitas
              dashboard.
            </p>
